# -*- coding: utf-8 -*-
"""Script to run the experiment for specificity in english with different parameters"""
...
for window_size in [ 4,5,8,10,15,20,25,30,35,40,46,52,60,80,100]:
...
# for window_size in [90,100,110]:
    for score_fn in score_fns:
        ...
        results, labels, scores = ecw.conduct(verbose = False, corpus = corpus, window_size = window_size, score_fn = score_fn, language='german')
